...
Je copie depuis  `AppComponent` l'array `appareils`. Je le colle  `AppareilService`. Je retourne dans  AppComponent  et je déclare  `appareils`  simplement comme un array de type  `any`. :joy:
